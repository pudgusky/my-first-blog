...
LEXERS = {
    ...
    'CSharpAspxLexer': ('pip._vendor.pygments.lexers.dotnet', 'aspx-css', ('aspx-css',), ('*.aspx', '*.asax', '*.ascx', '*.ashx', '*.asmx', '*.axd'), ()),
    'CSharpLexer': ('pip._vendor.pygments.lexers.dotnet', 'C#', ('csharp', 'c#', 'css'), ('*.css',), ('text/x-csharp',)),
